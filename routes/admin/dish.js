...
/*
*POST /admin/dish
*请求参数：{title:'xx',imgUrl:'..jpg',price:xx,details:'xx',categoryId:xx}
*添加一个新的菜品
*输出消息：{code:200,msg:'dish added succ',did:46}
*/
router.post('/',(req,res)=>{
...
*DELETE /admin/：did
*更具只当的菜品编号删除该菜品
*输出消息：{code:200,msg:'dish delete succ'}
...
router.delete('/:did',(req,res)=>{
  pool.query('DELETE FROM xfn_dish WHERE did=?',req.params.did,(err,result)=>{
    if (err) throw err;
    if(affectedRows>1){
      res.send({code:200,msg:'dish delete succ'})
    }
    else{
...
/*
*PUT /admin/dish
*请求参数：{did:'xx',title:'xx',price:xx,details:'xx',categoryId:xx,imgUrl:'..jpg'}
*添加一个新的菜品
*输出消息：{code:200,msg:'dish update succ'}
*输出消息：{code:400,msg:'dish not exists'}
*/